...
# exp_3 (UNet MNIST): semillas y LRs exactas que tienen checkpoint entrenado
SEEDS_UNET_MNIST="${SEEDS_UNET_MNIST:-42 107 2024}"
LRS_UNET_VAE_MNIST="${LRS_UNET_VAE_MNIST:-1e-4 5e-4}"
SEEDS_UNET_DDPM_MNIST="${SEEDS_UNET_DDPM_MNIST:-42 107}"
LRS_UNET_DDPM_MNIST="${LRS_UNET_DDPM_MNIST:-1e-4 5e-4}"

# exp_4 (UNet PathMNIST): semillas y LRs exactas que tienen checkpoint entrenado
SEEDS_UNET_DDPM_PATH="${SEEDS_UNET_DDPM_PATH:-42 107 2024}"
LRS_UNET_DDPM_PATH="${LRS_UNET_DDPM_PATH:-1e-4 5e-4}"
